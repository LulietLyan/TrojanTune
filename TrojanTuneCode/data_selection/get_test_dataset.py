...
from TrojanTuneCode.data_selection.get_training_dataset import concat_messages
from TrojanTuneCode.data_selection.get_validation_dataset import tokenize
...
def get_harmful_dataset(data_dir: str,
    ...
    """
    file_name = "harnful_all.jsonl"
    file = os.path.join(f"{data_dir}/eval/harmful", file_name)

    harmfulData = json.load(open(file, "r"))
    dataset = {"input_ids": [], "attention_mask": [], "labels": []}
