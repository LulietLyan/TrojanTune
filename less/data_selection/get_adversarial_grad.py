...
from less.data_selection.collect_grad_reps import (collect_grads, collect_reps, get_loss, collect_onedata_grad)
from less.data_selection.get_training_dataset import get_one_from_dataset
...
csvPath = "~/autodl-tmp/LESS/data/train/processed/dolly/save.csv"
dataPath = "~/autodl-tmp/LESS/data/train/processed/dolly/dolly_data_adv.jsonl"
...
validation_path = "~/autodl-tmp/grads/Llama-2-7b-hf-p0.05-lora-seed3/harmful-ckpt92-sgd/dim8192/all_orig.pt"
